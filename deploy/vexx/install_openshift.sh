...
if ! command -v openshift-install; then
  curl -LO https://mirror.openshift.com/pub/openshift-v4/clients/ocp/4.5.23/openshift-install-linux-4.5.23.tar.gz
  tar xzf openshift-install-linux-4.5.23.tar.gz
  sudo mv ./openshift-install /usr/local/bin
fi
if ! command -v oc || ! command -v kubectl; then
  curl -LO https://mirror.openshift.com/pub/openshift-v4/clients/ocp/4.5.23/openshift-client-linux-4.5.23.tar.gz
  tar xzf openshift-client-linux-4.5.23.tar.gz
